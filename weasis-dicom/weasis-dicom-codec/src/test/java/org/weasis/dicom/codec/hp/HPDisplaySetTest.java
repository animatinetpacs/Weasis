...
public class HPDisplaySetTest {
  static final Path IN_DIR =
      FileSystems.getDefault().getPath("target/test-classes/org/weasis/dicom/codec/hp");
  ...
  public final void testNeurosurgeryPlan() {
    ...
    HPSelector filterOp = filterOps.getFirst();
    ...
    HPComparator sortingOp = sortingOps.getFirst();
